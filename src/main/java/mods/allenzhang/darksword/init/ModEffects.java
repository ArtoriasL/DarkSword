...
public class ModEffects {
    ...
    public static final EffectBase STRICK = new EffectBase("skill_strick",false,0000000).setIconIndex(7,1).setEffectID(102).setDurationSecond(2d).setAttackDamage(1).setItemDamage(1).setPlayerLevel(20);
    ...
    public static final EffectBase DARKSTORM = new EffectBase("skill_darkstorm",false,0000000).setIconIndex(7,1).setEffectID(103).setDurationSecond(3.5d).setAttackDamage(0.8).setItemDamage(2).setPlayerLevel(30);
